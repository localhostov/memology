...
const gameMode: Record<TGameModeType, IGameInfo> = {
    history: {
        title: "Об истории",
        description:
            "История - режим для игры с друзьями. Вам нужно составить осмысленное предложение исходя из предыдущего предложения или начать писать своё. Самое главное - чтобы получилось интересно",
        route: "/games/history",
    },
}
